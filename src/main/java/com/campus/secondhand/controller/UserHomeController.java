...
public class UserHomeController {
    ...
    private void refreshGoods() {
        try {
            ...
            GoodsSortOption sortOption = sortBox == null ? GoodsSortOption.LATEST : sortBox.getSelectionModel().getSelectedItem();
            goodsTable.setItems(FXCollections.observableArrayList(goodsService.listPublicGoods(keyword, category, sortOption)));
            setMessage("已加载可见商品。");
